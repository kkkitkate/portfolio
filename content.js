...
const PROJECTS=[
  // 2026
  {sortDate:'2026-07-01',year:'2026',title:'Горький фест 2026',director:'Алексей Золотовицкий',designer:'',theatre:'Горький фест'},
  ...
  {sortDate:'2026-04-25',year:'2026',title:'Саша, привет!',director:'Алексей Золотовицкий',designer:'София Егорова',theatre:'Калининградский областной театр драмы'},
  {sortDate:'2026-03-21',year:'2026',title:'Сказки народов России',director:'',designer:'',extraCredit:'видеоконтент в сотрудничестве с Алиной Синяковой',theatre:'Национальный академический оркестр народных инструментов России имени Н. П. Осипова · Концертный зал Чайковского',external:'https://meloman.ru/kids/concerts/kzch-2026-03-21/'},
  ...
  {sortDate:'2026-02-22',year:'2026',title:'Змей Горыныч и другие диковинные звери',director:'',designer:'',extraCredit:'видеоконтент в сотрудничестве с Алиной Синяковой',theatre:'Национальный академический оркестр народных инструментов России имени Н. П. Осипова · Концертный зал Чайковского',external:'https://meloman.ru/kids/concerts/kzch-2026-02-22/'},
  {sortDate:'2026-01-14',year:'2026',title:'Федя Булкин',director:'Юрий Печенежский',designer:'Леша Лобанов',theatre:'Театр Практика',external:'https://praktikatheatre.ru/events/fedya'},
  ...
  {sortDate:'2025-11-30',year:'2025',title:'Концерт Fire Granny',director:'',designer:'',theatre:'16 тонн'},
  ...
  {sortDate:'2025-11-07',year:'2025',title:'Концерты Обе Две',director:'',designer:'',theatre:'Studio Rays · Санкт-Петербург и Москва'},
  {sortDate:'2025-09-19',year:'2025',title:'Колобок',director:'',designer:'',theatre:'Музыкальный гастро-спектакль · ВкусВилл на Красной Пресне',cover:'assets/kolobok-green.png',featured:true,internal:'projects/kolobok.html',external:'https://vk.ru/wall33395401_5113'},
  ...
  {sortDate:'2025-07-01',year:'2025',title:'Пастух и пастушка',director:'Сергей Сотников',designer:'',theatre:'Театр Наций'},
  {sortDate:'2025-07-01',year:'2025',title:'Жюли',director:'Джеймс Нобо',designer:'Анастасия Юдина',theatre:'Театр Наций'},
  ...
  {sortDate:'2025-07-01',year:'2025',title:'Охота жить — обновление видеоконтента',director:'Алена Лаптева',designer:'',theatre:'Театр Олега Табакова',external:'https://tabakov.ru/performances/okhota_zhit/'},
  ...
  {sortDate:'2024-07-01',year:'2024',title:'Географ глобус пропил',director:'Андрей Цисарук',designer:'',theatre:'Тверской академический театр драмы',external:'https://tatd.ru/repertoire/large_stage/geograf-globus-propil-/'},
  {sortDate:'2024-07-01',year:'2024',title:'Шинель',director:'Андрей Цисарук',designer:'',theatre:'Театр имени Волкова'},
  {sortDate:'2024-07-01',year:'2024',title:'Денискины рассказы',director:'Дмитрий Сердюк',designer:'',theatre:'Фестиваль «НЕБО»'},
  {sortDate:'2024-07-01',year:'2024',title:'Конек Горбунок',director:'Юрий Печенежский',designer:'',theatre:'Фестиваль «НЕБО»'},
  {sortDate:'2024-07-01',year:'2024',title:'Прогулка в городе Т',director:'Дмитрий Сердюк',designer:'',extraCredit:'автор идеи Анастасия Егорова',theatre:'Фестиваль «Горький+» · Нижний Новгород'},
  {sortDate:'2024-03-25',year:'2024',title:'Когда мы умели летать',director:'Михаил Елисеев',designer:'',theatre:'',external:'https://www.afisha.ru/performance/kogda-my-umeli-letat-266807/'},
  {sortDate:'2024-01-20',year:'2024',title:'Жан и Беатриса',director:'Дмитрий Сердюк',designer:'',theatre:'',external:'https://afisha.london/event/spektakl-po-pese-karolya-freshetta-zhan-i-beatrisa/'},
